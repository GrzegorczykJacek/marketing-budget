        ...
        try {
            return new Configuration()
                    .setProperty(HIBERNATE_CONNECTION_URL,
                            EnvironmentVariableUtil.getEnvVariable(HIBERNATE_CONNECTION_URL))
                    .setProperty(HIBERNATE_CONNECTION_USERNAME,
                            EnvironmentVariableUtil.getEnvVariable(HIBERNATE_CONNECTION_USERNAME))
                    .setProperty(HIBERNATE_CONNECTION_PASSWORD,
                            EnvironmentVariableUtil.getEnvVariable(HIBERNATE_CONNECTION_PASSWORD))
                    .configure()
                    .buildSessionFactory();
        } catch (Throwable ex) {
